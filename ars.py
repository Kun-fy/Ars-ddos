            ...
            try:
                ...
                for i in range(speedPerRun): 
                    try:
                        ...
                        print(Colors.BOLD + Colors.WARNING + "Packet Amount :>  " + Colors.WHITE + str(Count.packetCounter)) 
                        print(Colors.BOLD + Colors.OKGREEN + "Protocol Add  :>  " + Colors.WHITE + str(ip))
                        Count.packetCounter = Count.packetCounter + 1
                        print(Colors.BOLD + Colors.FAIL + "Attack Time   :>  " + Colors.WHITE + time.strftime("%d-%m-%Y %H:%M:%S", time.gmtime()) + Colors.OKGREEN + "")
                    except socket.error:
